  ...
  <table class="table table-striped table-sm">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><a class="btn btn-info btn-sm" href="">Edit</a> | <a id="trash-user-{{$user->id}}" class="btn btn-warning btn-sm" href="">Trash</a> | <a class="btn btn-danger btn-sm" href="javascript:;" onclick="confirmDelete('{{$user->id}}')">Delete</a>
